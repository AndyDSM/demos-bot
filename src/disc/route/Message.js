...
let util = require('demos-util');
let Embed = require('demos-util/discord/embed');
let CommandSet = require('djs-router/cmd').Set;
let States = require('../state/States.js');
let C = require('demos-console');
...
CommandSet_.addCmd(require('../cmds/admin/cmd.js'));
